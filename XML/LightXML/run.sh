...
if [ "$1" = "amazon670k" ]; then
    ...
    echo start $1 
    python src/main.py --lr 1e-4 --epoch 3 --dataset $1 --swa --swa_warmup 2 --swa_step 200 --batch 16 --max_len 128  
    python src/main.py --lr 1e-4 --epoch 3 --dataset $1 --swa --swa_warmup 2 --swa_step 200 --batch 16 --bert roberta --max_len 128
